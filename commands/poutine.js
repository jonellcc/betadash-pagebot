...
module.exports = {
  name: 'poutine',
  description: 'Generate canvas poutine',
  usage: 'poutine <userid>',
  author: 'cliff',
  async execute(senderId, args, pageAccessToken, sendMessage) {
    ...
    try {
      const apiUrl = `https://apiv2.kenliejugarap.com/poutine?url=https://api-canvass.vercel.app/profile?uid=${uid}`;

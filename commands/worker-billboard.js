...
module.exports = {
  name: 'worker-billboard',
  description: 'worker-billboard canvas',
  usage: 'worker-billboard <userid>',
  author: 'cliff',
  async execute(senderId, args, pageAccessToken, sendMessage) {
    ...
    try {    
      const apiUrl = `https://api-canvass.vercel.app/worker-billboard?userid=${encodeURIComponent(uid)}`;

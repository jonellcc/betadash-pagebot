...
module.exports = {
  name: 'rainbow',
  description: 'Generate canvas rainbow image',
  usage: 'rainbow <userid>',
  author: 'cliff',
  async execute(senderId, args, pageAccessToken, sendMessage) {
    ...
    try {
      const apiUrl = `https://apiv2.kenliejugarap.com/gay?url=https://api-canvass.vercel.app/profile?uid=${uid}`;

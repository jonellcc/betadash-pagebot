...
module.exports = {
  name: 'beautiful',
  description: 'Generate canvas beautiful image',
  usage: 'beautiful <userid>',
  author: 'cliff',
  async execute(senderId, args, pageAccessToken, sendMessage) {
    ...
    try {
      const apiUrl = `https://apiv2.kenliejugarap.com/beautiful?url=https://api-canvass.vercel.app/profile?uid=${uid}`;

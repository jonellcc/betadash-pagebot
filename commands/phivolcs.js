...
module.exports = {
  name: 'philvolcs',
  description: 'Toggle auto earthquake updates from PHIVOLCS Official.',
  usage: 'philvolcs on | off',
  category: 'tools',
  author: 'Kyu',
  async execute(senderId, sendMessage, args, pageAccessToken) {
    ...
    if (option === 'on') {
      ...
      await sendMessage(senderId, {
        text: '✅ 𝗘𝗮𝗿𝘁𝗵𝗾𝘂𝗮𝗸𝗲 𝗮𝘂𝘁𝗼-𝘂𝗽𝗱𝗮𝘁𝗲 𝗮𝗰𝘁𝗶𝘃𝗮𝘁𝗲𝗱.\n📡 I’ll send new PHIVOLCS alerts automatically.'
      }, pageAccessToken);

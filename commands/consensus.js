...
module.exports = {
  name: 'cosensus',
  description: 'Ai powdered Academic Search Engine.',
...
await sendMessage(senderId, { text: '🔍 Searching Please Wait....' }, pageAccessToken);
      const apiUrl = `https://betadash-api-swordslush-production.up.railway.app/consensus?q=${encodeURIComponent(prompt)}`;

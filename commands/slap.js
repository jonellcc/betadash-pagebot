...
module.exports = {
  name: 'slap',
  description: 'Generate canvas batman slapped by supperman',
  usage: 'slap <userid>',
  author: 'cliff',
  async execute(senderId, args, pageAccessToken, sendMessage) {
    ...
    try {
      const apiUrl = `https://apiv2.kenliejugarap.com/slap?url=https://api-canvass.vercel.app/profile?uid=${uid}`;

...
module.exports = {
  name: 'babbage',
  description: 'Ask a question to babbage Ai',
...
if (!prompt) {
    ...
    try {
      const apiUrl = `https://betadash-api-swordslush.vercel.app/babbage-002?ask=${encodeURIComponent(prompt)}`;

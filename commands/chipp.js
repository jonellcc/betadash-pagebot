...
module.exports = {
  name: 'chipp',
  description: 'Ask a question to chippai gpt4o model',
...
await sendMessage(senderId, { text: '🔍 Searching Please Wait....' }, pageAccessToken);
      const apiUrl = `https://betadash-api-swordslush-production.up.railway.app/chipp?ask=${encodeURIComponent(prompt)}`;

...
module.exports = {
  name: "maid",
  description: "Generate a canvas maid",
  usage: "maid one two",
...
const kupal = ["8505900689447357", "8269473539829237", "7913024942132935"];
  ...
  return;
    ...
    try {
      ...
      if (!one || !two) {
        return sendMessage(senderId, { text: "Invalid Usage: Use maid <uid1> <uid2>" }, pageAccessToken);
      }

      const apiUrl = `https://apiv2.kenliejugarap.com/maid?pic1=https://api-canvass.vercel.app/profile?uid=${one}&pic2=https://api-canvass.vercel.app/profile?uid=${two}`;

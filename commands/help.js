...
const randomQuotes = [
  ...
  "Termites are active 24 hours a day and they do not sleep. Studies have also found that termites gnaw wood twice as fast when listening to heavy rock music.",
  ...
  "Penguins are the only birds that can swim, but not fly. Nor have any penguins been found in the Arctic.",
  ...
  "The flea can jump 350 times its body length. If it also possessed that ability, a human would be able to jump the length of a football field once.",
  "The faster the kangaroo jumps, the less energy it consumes.",
  "Elephants are among the few mammals that can't jump! It was also discovered that elephants still stand after death.",
  ...
  "The single pair of wings on the back and the rear stabilizer help the flies to fly continuously, but their lifespan is not more than 14 days.",
  "With a pair of endlessly long legs that can be up to 1.5 m high and weigh 20-25 kg, the ostrich can run faster than a horse. In addition, male ostriches can roar like a lion.",
  "Kangaroos use their tails for balance, so if you lift a Kangaroo's tail off the ground, it won't be able to jump and stand.",
  "Tigers not only have stripes on their backs but also printed on their skin. Each individual tiger is born with its own unique stripe.",
  ...
  "Fleas can jump up to 200 times their height. This is equivalent to a man jumping on the Empire State Building in New York.",
  "A cat has up to 32 muscles in the ear. That makes them have superior hearing ability",
  "Koalas have a taste that does not change throughout life, they eat almost nothing but .. leaves of the eucalyptus tree.",
  "The beaver's teeth do not stop growing throughout its life. If you do not want the teeth to be too long and difficult to control, the beaver must eat hard foods to wear them down.",
  ...
  "Dog nose prints are like human fingerprints and can be used to identify different dogs."
];
...
module.exports = {
  ...
  usage: "𝗁𝖾𝗅𝗉 <𝗇𝗎𝗆𝖻𝖾𝗋𝗉𝖺𝗀𝖾> | <𝖼𝗆𝖽𝖭𝖺𝗆𝖾> | <all>",
  author: 'Cliff',
  async execute(senderId, args, pageAccessToken, sendMessage) {
    ...
    if (args.length > 0 && isNaN(args[0])) {
      ...
      if (commandFile) {
        ...
        const allCommandsList = commandFiles.map(file => {
    ...
    if (paginatedCommands.length === 0) {
      await sendMessage(senderId, { text: `❌ 𝖭𝗈 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌 𝖿𝗈𝗎𝗇𝖽 𝖿𝗈𝗋 𝗉𝖺𝗀𝖾: ${pageNumber}` }, pageAccessToken);
      return;
    }

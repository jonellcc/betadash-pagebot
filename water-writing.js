...
module.exports = {
  name: 'water-writting',
  description: 'water-writting canvas',
  usage: 'water-writting <text>',
  author: 'cliff',
  async execute(senderId, args, pageAccessToken, sendMessage) {
    ...
    try {
      const apiUrl = `https://betadash-api-swordslush-production.up.railway.app/water-writing?text=${encodeURIComponent(prompt)}`;
